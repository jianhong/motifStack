...
It can also be used to draw affinity logos given a position specific affinity matrix (PSAM) \cite{@foat2006statistical}.
...
```
```{r logostack2,fig.cap="Plot motifs with sequence logo stack style",fig.width=4,fig.height=4}
motif2 <- motif
